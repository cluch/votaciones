...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo site_url("style/style.css"); ?>" />
	<link rel="stylesheet" type="text/css" href="<?php echo site_url("style/style_print.css"); ?>" media="print" />
</head>
<body>
